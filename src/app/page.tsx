...
function FiBot() { return <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="10" rx="2"/><circle cx="9" cy="16" r="1"/><circle cx="15" cy="16" r="1"/><path d="M8 11V8a4 4 0 0 1 8 0v3"/><line x1="12" y1="4" x2="12" y2="2"/><circle cx="12" cy="2" r="1"/></svg>; }
function FiMap() { return <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><polygon points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6"/><line x1="8" y1="2" x2="8" y2="18"/><line x1="16" y1="6" x2="16" y2="22"/></svg>; }
...
function FiTicket() { return <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M2 9a3 3 0 0 1 0 6v5a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1v-5a3 3 0 0 1 0-6V4a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v5z"/><path d="M13 5v2M13 17v2M13 11v2"/></svg>; }
...
function FiChart() { return <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/><line x1="2" y1="20" x2="22" y2="20"/></svg>; }
function FiShield() { return <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>; }
...
function FiBell() { return <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>; }
    ...
    <>
      ...
      <main className="flex-1 pb-20 md:pb-0">
        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-[var(--hero-from)] via-background to-background transition-colors">
          ...
          <div className="absolute -left-20 top-20 h-[500px] w-[500px] rounded-full bg-accent/15 blur-[100px]" />
          <div className="absolute -right-20 top-40 h-[400px] w-[400px] rounded-full bg-cyan-500/12 blur-[80px]" />
          <div className="absolute left-1/2 bottom-0 h-[300px] w-[600px] -translate-x-1/2 rounded-full bg-amber-500/8 blur-[80px]" />
          ...
          <div className="relative mx-auto max-w-7xl px-6 pb-16 pt-12 md:pb-24 md:pt-16">
            ...
            <div className="text-center">
              <div className="inline-flex items-center gap-2 rounded-full border border-accent/20 bg-accent/5 px-4 py-1.5">
                ...
                <span className="text-[12px] font-semibold text-accent">300,000+ Experiences · 3,000+ Cities · 10 Supplier APIs</span>
              </div>
            </div>
            ...
            <p className="mx-auto mt-4 max-w-2xl text-center text-[15px] leading-[1.7] text-muted">
              One platform connecting tour operators, DMCs and travel agencies to 300,000+ experiences across 3,000+ cities — powered by 10 supplier APIs, AI agents and real-time data. Exclusive B2B rates, locked behind membership.
            </p>
              ...
              <div className="hidden lg:flex lg:flex-col">
                <div className="grid grid-cols-[0.8fr_1fr] gap-3 flex-1">
                  ...
                  <div className="relative h-full overflow-hidden rounded-2xl shadow-2xl shadow-black/20">
                    <ImageSlider
                      images={heroImages.length > 0 ? heroImages : ["/images/cat-museums.jpg", "/images/cat-walking.jpg", "/images/cat-attractions.jpg", "/images/cat-cruises.jpg", "/images/cat-restaurants.jpg", "/images/cat-transport.jpg"]}
                    ...
                    <div className="absolute bottom-0 left-0 right-0 z-[2] p-5">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[11px] font-semibold text-emerald-300">12 categories · 3,000+ cities</span>
                      </div>
                      <p className="text-[18px] font-extrabold text-white leading-tight">Museums. Tours.<br/>Cruises. Food.<br/>And so much more.</p>
                      <p className="mt-1.5 text-[11px] text-white/60">300,000+ experiences at exclusive B2B rates</p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-3 h-full">
                    <div className="relative flex-1 overflow-hidden rounded-2xl shadow-xl group bg-gray-50">
                      <img
                        src="/images/dashboard-commandcenter.jpg"
                    ...
                    <div className="relative flex-1 overflow-hidden rounded-2xl shadow-xl group bg-gray-50">
                      <img
                        src="/images/dashboard-experiences.jpg"
          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-5 text-[16px] leading-[1.8] text-muted">
                TicketMatch aggregates 300,000+ experiences from 10 supplier APIs into one powerful B2B platform.
              ...
              <div className="hidden md:block">
                <svg viewBox="0 0 800 820" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-3xl mx-auto">
                  ...
                  <g style={{ transformOrigin: "400px 72px", animation: "eco-breathe 5s ease-in-out infinite" }}>
                    ...
                    <text x="400" y="68" fontSize="16" fontWeight="800" fill="#065F46" textAnchor="middle" className="dark:fill-emerald-300">300,000+ Experiences</text>
                    <text x="400" y="88" fontSize="10" fill="#64748b" textAnchor="middle">Museums, Tours, Attractions, Food, Water, Transport — 3,000+ cities worldwide</text>
                  </g>
              ...
              <div className="flex flex-col gap-4 md:hidden">
                ...
                <div>
                  ...
                  <div className="rounded-xl bg-emerald-50 dark:bg-emerald-900/10 border-2 border-emerald-200 dark:border-emerald-500/30 p-4 text-center">
                    <p className="text-[14px] font-extrabold text-emerald-800 dark:text-emerald-300">300,000+ Experiences</p>
                    <p className="text-[11px] text-muted mt-1">Museums, Tours, Attractions — 3,000+ cities</p>
                  </div>
                </div>
            ...
            <div className="mt-14 grid gap-8 md:grid-cols-3">
              ...
              <div className="text-center">
                ...
                <p className="mt-2 text-[13px] leading-relaxed text-muted">
                  300,000+ experiences from 10 major supplier APIs across 3,000+ cities. Connected, aggregated and searchable in one powerful dashboard.
                </p>
              </div>
              <div className="text-center">
        ...
        <section id="how-it-works" className="py-24 md:py-32 bg-background transition-colors">
          <ScrollReveal>
          <div className="mx-auto max-w-7xl px-6">
            <div className="text-center">
            ...
            <div className="relative mt-14">
              ...
              <div className="relative z-10 grid gap-5 md:grid-cols-3">
                {[
                  ...
                  { step: "2", title: "Explore & Build", desc: "Browse 300,000+ experiences across 3,000+ cities. Create itineraries, let AI suggest the best matches, and compare exclusive B2B rates.", tags: ["300K+ experiences", "AI suggestions"], bg: "from-amber-500 to-orange-600", iconPath: "M3 4h18v18H3zM16 2v4M8 2v4M3 10h18M8 14h.01M12 14h.01M16 14h.01M8 18h.01M12 18h.01" },
        ...
        <section id="features" className="bg-gradient-to-b from-[var(--stats-from)] to-[var(--stats-to)] py-24 md:py-32 text-white transition-colors">
          <ScrollReveal>
          <div className="mx-auto max-w-7xl px-6">
            <div className="text-center">
            ...
            <div className="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                { Icon: FiMap, title: "Live City Map", desc: "Interactive Google Maps with live busyness data, walking routes and estimated travel times — powered by Google Places API across 3,000+ cities.", tag: "Live Data", tagColor: "bg-emerald-500/20 text-emerald-300" },
                ...
                <div key={f.title} className="group relative rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition-all hover:bg-white/10 hover:border-white/20">
          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="mx-auto max-w-3xl text-center mb-12">
              ...
              <p className="mt-4 text-[15px] leading-relaxed text-muted">
                300,000+ experiences across 3,000+ cities worldwide. Type any city to preview what&apos;s waiting for your clients.
              </p>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-6">
            <ScrollReveal>
              <div className="mx-auto max-w-3xl text-center mb-12">
                ...
                <p className="mt-4 text-[15px] leading-relaxed text-muted">
                  TicketMatch members unlock exclusive B2B rates across 300,000+ experiences. Here&apos;s what you&apos;re missing.
                </p>
              </div>
              <SaveVsRetail />
            </ScrollReveal>
          ...
          <div className="mx-auto max-w-7xl px-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div key={uc.role} className={`group relative overflow-hidden rounded-2xl bg-gradient-to-br ${uc.gradient} p-6 text-white transition-all hover:shadow-xl hover:scale-[1.02]`}>
                  ...
                  <div className="relative">
                    ...
                    <p className="text-[11px] font-medium text-white/60 uppercase tracking-wider">{uc.role}</p>
        ...
        <section id="pricing" className="relative overflow-hidden bg-gradient-to-b from-background via-surface-alt to-background py-24 md:py-32 transition-colors">
          ...
          <div className="relative mx-auto max-w-7xl px-6">
            ...
            <div className="mt-16 grid gap-6 md:grid-cols-3 md:items-start">
              {/* Explorer (Free) */}
              <div className="relative overflow-hidden rounded-2xl border border-card-border bg-card-bg p-8 transition-all hover:shadow-xl">
                ...
                <ul className="space-y-3">
                  {["Browse full experience catalog", "Live city map (3,000+ cities)", "1 team member", "AI assistant (Emma)", "Weather forecasts", "5 bookings per month", "Email notifications"].map((f) => (
                ...
                <Link
                  href="/auth/register"
                  className="mt-8 flex w-full items-center justify-center gap-2 rounded-full border border-border px-6 py-3.5 text-[13px] font-semibold transition-all hover:bg-surface-alt"
                >
              ...
              <div className="relative overflow-hidden rounded-2xl border-2 border-accent/30 bg-gradient-to-b from-accent/[0.03] to-card-bg p-8 shadow-xl shadow-accent/5 md:-mt-4 md:pb-10">
                ...
                <Link
                  href="/auth/register"
                  className="mt-8 flex w-full items-center justify-center gap-2 rounded-full bg-accent px-6 py-3.5 text-[13px] font-semibold text-white shadow-lg shadow-accent/25 transition-all hover:shadow-accent/40 hover:brightness-110"
                >
              ...
              {/* Enterprise */}
              <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-gray-900 to-gray-950 p-8 text-white transition-all hover:shadow-xl">
                ...
                <Link
                  href="/auth/register"
                  className="mt-8 flex w-full items-center justify-center gap-2 rounded-full bg-white px-6 py-3.5 text-[13px] font-semibold text-gray-900 transition-all hover:bg-gray-100"
                >
            ...
            <div className="mt-16 flex flex-col items-center gap-4 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 text-[12px] text-muted/60">
        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-gray-950 to-gray-900 py-24 md:py-32">
          {/* Decorative glows */}
          <div className="absolute -left-40 top-0 h-[400px] w-[400px] rounded-full bg-accent/20 blur-[120px]" />
          <div className="absolute -right-40 bottom-0 h-[400px] w-[400px] rounded-full bg-blue-600/15 blur-[120px]" />
          ...
          <div className="relative mx-auto max-w-4xl px-6 text-center">
            ...
            <h2 className="mt-6 text-3xl font-extrabold tracking-tight text-white md:text-[3rem] md:leading-[1.1]">
              300,000+ experiences.<br />10 supplier APIs.<br />One membership.
            </h2>
            <p className="mx-auto mt-5 max-w-lg text-[15px] leading-relaxed text-white/50">
              Tour operators, DMCs and travel agencies across Europe are joining TicketMatch. Get exclusive B2B access to 3,000+ cities, 8 AI agents, real-time data and smart automation — free to start.
            </p>
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <Link
                href="/auth/register"
                className="inline-flex items-center gap-2 rounded-full bg-white px-8 py-4 text-[14px] font-semibold text-gray-900 shadow-xl transition-all hover:bg-gray-100 hover:shadow-2xl"
              >
                Request Membership <IconArrow />
              </Link>
              <Link
                href="/partners"
                className="inline-flex items-center gap-2 rounded-full border border-white/20 px-8 py-4 text-[14px] font-semibold text-white transition-all hover:border-white/40 hover:bg-white/5"
              >
                Become a Supplier
              </Link>
            </div>
