...
const tiers = [
  {
    ...
    note: "First 3 months after referral signs up",
    threshold: 0,
...
const stats = [
  ...
  { label: "Active Referrals", value: "0", icon: "check" },
  { label: "Total Earned", value: "\u20AC 0.00", icon: "euro" },
...
export default function AffiliatePage() {
  ...
  const shareWhatsApp = () => {
    const text = encodeURIComponent(
      `Hey! I've been using TicketMatch.ai for group tour bookings. Check it out: ${referralLink}`
    );
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-border/60 bg-white p-6 md:p-8 shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="flex-1 flex items-center gap-2 rounded-xl bg-gray-50 border border-gray-200 px-4 py-3">
            ...
            <span className="text-sm font-mono text-gray-700 truncate select-all">
              {referralLink}
            </span>
          </div>
          <button
        ...
        <div className="flex flex-wrap gap-3 mt-5">
          <button
            onClick={shareEmail}
            className="flex items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-100 hover:border-gray-300 transition-all"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-green-200 bg-green-50 px-4 py-2.5 text-sm font-medium text-green-700 hover:bg-green-100 hover:border-green-300 transition-all"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-4 py-2.5 text-sm font-medium text-blue-700 hover:bg-blue-100 hover:border-blue-300 transition-all"
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mb-5">
          Refer more operators to unlock higher commission rates
        </p>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center gap-2 mb-4">
                  <div
                    className={`flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br ${tier.color} text-white shadow-sm`}
                  >
                    {i === 0 ? (
                      ...
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <path d="M18 20h1.5a2.5 2.5 0 0 1 0 5" />
                  ...
                  <div>
                    ...
                    {tier.threshold > 0 && (
                      <p className="text-xs text-gray-400">{tier.threshold}+ referrals</p>
                    )}
                  </div>
                </div>
                <div className="mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            },
            {
              ...
              desc: "Earn a percentage of every booking they make. Commissions are paid out monthly.",
              icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="12" r="10" />
