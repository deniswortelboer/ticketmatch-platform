          ...
          {activeTab === "notifications" && (
            <div className="rounded-2xl border border-border/60 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-3 max-w-lg">
                {[
                  { key: "booking_confirmations", label: "Booking confirmations", desc: "Receive email when a booking is confirmed or updated." },
                  { key: "new_venues", label: "New venues added", desc: "Get notified when new venues are added to the catalog." },
                  { key: "weekly_summary", label: "Weekly summary", desc: "Receive a weekly overview of your bookings and groups." },
                  { key: "marketing", label: "Marketing & updates", desc: "News about new features, tips, and platform updates." },
                ].map((item) => (
                  <div key={item.key} className="flex items-center justify-between rounded-xl border border-border/40 px-5 py-4">
                    <div>
              ...
              <button
                ...
                className="mt-6 rounded-xl bg-foreground px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-gray-800"
              >
                Save Preferences
              </button>
            </div>
